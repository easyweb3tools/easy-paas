...
This directory holds OpenClaw skills for the easyweb3 v2 PaaS.
...
At runtime, OpenClaw loads skills from the workspace:
...
Inside OpenClaw runtime (host or container), set:
